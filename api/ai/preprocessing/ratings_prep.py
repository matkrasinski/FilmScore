...
import numpy as np
import os
from api.ai.preprocessing.companies_ratings import get_companies_ratings
...
def generate_ratings():
  ...
  people_ratings = pd.DataFrame({'nconst': people_ratings.index, 'value_column': people_ratings.values})
